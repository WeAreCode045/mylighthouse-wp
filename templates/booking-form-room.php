...
<div class="mlb-booking-form mlb-layout-<?php echo esc_attr($layout); ?> mlb-placement-<?php echo esc_attr($placement); ?> mlb-room-form" data-layout="<?php echo esc_attr($layout); ?>" data-button-placement="<?php echo esc_attr($placement); ?>" data-single-button="true">
    <form id="<?php echo esc_attr($form_uid); ?>" class="mlb-form" method="GET" action="<?php echo esc_url($booking_page_url); ?>" data-hotel-id="<?php echo esc_attr($default_hotel_id); ?>" data-room-id="<?php echo esc_attr($room_id); ?>" data-hotel-name="<?php echo esc_attr($hotel_name); ?>" data-room-name="<?php echo esc_attr($room_name); ?>">
