    ...
    <div class="mlb-modal-overlay">
        <div class="mlb-modal-content">
            ...
            <div class="mlb-modal-actions">
                <button type="button" class="mlb-button mlb-button-secondary mlb-date-cancel">
                    <?php esc_html_e('Cancel', 'mylighthouse-booker'); ?>
                </button>
                <button type="button" class="mlb-button mlb-button-primary mlb-date-confirm" disabled>
                    <?php esc_html_e('Confirm Dates', 'mylighthouse-booker'); ?>
                </button>
            </div>
        </div>
    </div>
