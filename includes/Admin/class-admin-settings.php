                ...
                <form method="post" action="<?php echo esc_url(admin_url('admin.php')); ?>">
                    <?php if ($sub === 'general') : ?>
                        ...
                        <table class="form-table">
                            <tr>
                                <th scope="row"><?php esc_html_e('Booking Engine URL', 'mylighthouse-booker'); ?></th>
                                <td>
                                    <input type="text" name="mlb_booking_page_url" value="<?php echo esc_attr($booking_page); ?>" class="regular-text mlb-input" placeholder="<?php echo esc_attr(esc_html__('https://bookingengine.mylighthouse.com/', 'mylighthouse-booker')); ?>" />
                                    <p class="description"><?php esc_html_e('External booking engine URL. All bookings will redirect to this URL with the selected options.', 'mylighthouse-booker'); ?></p>
                                </td>
                            </tr>
                            <tr>
