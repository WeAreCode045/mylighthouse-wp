...
class Mylighthouse_Booker_Ajax_Handlers
{
	...
	public function handle_save_admin_settings()
	{
		...
		$display_mode = isset($_POST['mlb_display_mode']) && in_array($_POST['mlb_display_mode'], array('modal','booking_page')) ? sanitize_text_field($_POST['mlb_display_mode']) : 'modal';
		...
		update_option('mlb_display_mode', $display_mode);
